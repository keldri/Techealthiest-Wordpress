...
function get_tweets() {
    ...
    // Do API call
    $response = wp_remote_retrieve_body( wp_remote_get( 'https://cdn.api.twitter.com/1/urls/count.json?url=' . urlencode( get_permalink( $post->ID ) ), array(
...
function get_fb() {
    ...
    $fql .= "FROM link_stat WHERE url = '" . get_permalink( $post->ID ) . "'";

    // Do API call
    $response = wp_remote_retrieve_body( wp_remote_get( 'https://api.facebook.com/method/fql.query?format=json&query=' . urlencode( $fql ), array(
...
function get_pinterest() {
    ...
    // Do API call
    $response = wp_remote_retrieve_body( wp_remote_get( 'http://api.pinterest.com/v1/urls/count.json?url=' . urlencode( get_permalink( $post->ID ) ), array(
